...
public class GuiBloodFactory extends GuiContainer {
    ...
    public GuiBloodFactory(TileBloodFactory te, EntityPlayer player) {
        super(new ContainerBloodFactory(player, te));
        this.te = te;
        this.player = player;
